...
by one, you become wounded.\footnote{``Fall down and start bleeding.''}  Bullets are represented by nerf darts.  Ammunition is limited; ammo that hits the floor leaves game. Each gun in game will have specific instructions on it for how to reload it, if this is at all possible.
