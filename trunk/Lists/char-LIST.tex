...
\NEW{PC}{\cActive}{
   \s\MYname	{Kelly Gordon}
   \s\MYfile	{ActiveAlien.tex}
   \s\MYsex      {\female}
   \s\MYnumber	{326}
    \s\MYdesc     {A non-descript middle aged woman.}
   
  \s\MYblues	{}
  \s\MYgreens	{\gVirus{}\nBrainDamage{}}
  \s\MYabils	{\aMentalDegradation{}\aCollectBlood{}\aPossessAlienBody{}
  							\aAssist{}\aKnockOut{}\aWound{}\aRestrain{}}
  \s\MYitems	{\iAlienMilitaryTech{}}
...
\s\MYgreens	{\gVirus{}\gPrepareWedding{}\gWedding{}\gPoisonMaking{}}
  \s\MYabils	{\aAssist{}\aKnockOut{}\aWound{}\aRestrain{}}
  \s\MYitems	{\iBrideKey{}\iRing{}}
   \s\MYomega	{12} % Corruption
\s\MYmems {\mVirus{}\mGod{}\mHotAlien{}\mDead{}}
\s\MYcr	{2}
 }
...
\NEW{PC}{\cGroomA}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{438}
    \s\MYdesc     {A hansome, well dressed, older gentlman.}
 ...
 \s\MYmems {\mVirus{}\mGod{}\mDead{}\mGroomnessA{}}
\s\MYcr	{3}
}
...
\NEW{PC}{\cGroomB}{
   ...
   \s\MYfile	{GroomB.tex}
   \s\MYsex      {\male}
   \s\MYnumber	{439} %can they have exactly the same badge #?  Yes -Ghost
   \s\MYdesc     {A hansome, well dressed, older gentlman.}
  ...
  \s\MYitems	{\iGroomKey{}}
  \s\MYomega	{8} % Corruption
\s\MYmems {\mVirus{}\mGod{}\mDead{}\mGroomnessB{}}
\s\MYcr	{3}
 }

\NEW{PC}{\cKid}{
   \s\MYname	{Billy Pulaski}
   \s\MYfile	{Kid.tex}
   \s\MYsex      {\male}
   \s\MYnumber	{014}
...
\NEW{PC}{\cPassive}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{321}
   \s\MYdesc     {A non-descript, middle age woman.}
...
\NEW{PC}{\cPastor}{
  ...
  \s\MYgreens	{\gVirus{}\gPrepareWedding{}\gWedding{}
  						\aAssist{}\aKnockOut{}\aWound{}\aRestrain{}}
  \s\MYabils	{}
  \s\MYitems	{\iPastorKey{}\iHighSecurityKey{}}
  \s\MYomega	{12} % Corruption
...
\NEW{PC}{\cProgrammer}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{500}
   \s\MYdesc     {A tall, casually dressed man.}
   
  \s\MYblues	{}
  \s\MYgreens	{\gVirus{}}
  \s\MYabils	{\aVirusLevel{}\aDebug{}}
  \s\MYitems	{}
...
\NEW{PC}{\cRival}{
   ...
   \s\MYsex      {\male}
   \s\MYnumber	{227}
   \s\MYdesc     {A young, male scientist.}
...
\NEW{PC}{\cScientist}{
   ...
   \s\MYsex      {\female}
   \s\MYnumber	{429}
   \s\MYdesc     {An older female scientist.}
   
  \s\MYblues	{}
  \s\MYgreens	{\gVirus{}\gHacking{}}
  \s\MYabils	{\aAssist{}\aKnockOut{}\aWound{}\aRestrain{}}
  \s\MYitems	{\iScientistKey{}\iIncompleteMentalAmplifier{}\iDrug{}}
