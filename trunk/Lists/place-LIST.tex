...
\NEW{Place}{\pConstructionSite}{
  \s\MYname	{Hall off of -002}
	\s\MYsigns	{\sToolbox{}\sPileOfWood{}}
  \s\MYitems	{}
  }
  
\NEW{Place}{\pLobby}{
  \s\MYname	{Main Hallway}
	\s\MYsigns	{\sReception{}\sPortrait{}}
  \s\MYitems	{}
  }
...
\NEW{Place}{\pReality}{
  \s\MYname	{-015}
	\s\MYsigns	{\sSimStateExplained{}\sBrokenSim{}\sBrokenSimTwo{}\sFixedSim{}\sUtopianSim{}\sRope{}\sReturnToSim{}\sPossessABody{}\sHallwayBlocked{}\sAlienBodies{}}
  \s\MYitems	{}
  }
  
\NEW{Place}{\pGiftShop}{
  \s\MYname	{-030}
	\s\MYsigns	{\sGiftShop{}\sGiftShopDisplay{}\sGiftShopStuffies{}}
  \s\MYitems	{}
  }
