...
\NEW{Sign}{\sBarCounter}{
  ...
  If you would like to search behind the counter, place both hands on this sign for 30 seconds. You may then take 1 item from the counter. The items here are essensially infinite in quantity. If the envelop is empty, tell a GM.
}
