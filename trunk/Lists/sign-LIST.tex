...
{\bf 3. } Hack your way in. The lock has a difficulty level of {\bf 1}.
...
\NEW{Sign}{\sPossessABody}{
  ...
  If you wish to destroy one of the alien bodies, you may do so. If you choose to do so, you must inform a GM before you begin. The action takes 5 minutes and is interruptable.  If you succeed in killing the body, tear up one of the notecards marked ``Alien''.
  
  All bodies have CR 0.}
  }
...
\NEW{Sign}{\sPileOfJunk}{
  ...
  \s\MYitems {\iWidget{}\multi{4}{\iwire{}}\iBible{}\multi{2}\isyringe{}}
  }
