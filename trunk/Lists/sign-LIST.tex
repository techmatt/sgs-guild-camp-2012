...
\NEW{Sign}{\sTV}{
  ...
  \s\MYloc	{- 002}
  \s\MYtext	{Oh, the TV is playing. Yet the switch seems to indicate that it’s turned off…?

If you watch it for a moment, it’s clear that the same two ads are playing, over and over.
...
\NEW{Sign}{\sWater}{
  ...
  \s\MYtext	{There appears to be a floating aquarium in the middle of this hallway, blocking most of the passage. It is possible to squeeze by next to the wall if you’re careful.

But on closer inspection, this aquarium lacks glass. It is simply a cube of water, held in the shape of a cube by god-knows-what, with a single, very confused fish swimming around haphazardly inside.

If you have a strainer-like device and make a CR 2 attack, you can catch the fish. Open the packet below.}
  \s\MYitems {\iFish{} }
  }
%% THIS IS A GLITCH ITEM and it needs a star sticker
...
\NEW{Sign}{\sPortrait}{
  \s\MYname	{A Picture of the God of Virtuism \#444}
  \s\MYloc	{Main Hallway}
...
\NEW{Sign}{\sFlowers}{
  ...
  \s\MYloc	{Main Hallway}
  \s\MYtext	{What a lovely flower arrangement! This would look quite nice at the wedding.
 
  If you get close, you can hear a strange static noise coming from the vase. What could be making that sound? It’s grating.}
  \s\MYitems {\multi{10}{\i{Flowers{}} }
  }
  %% THIS IS A GLITCH ITEM and it needs a star sticker
...
\NEW{Sign}{\sRealityCheck}{
  \s\MYname	{Caution: You are about to leave the simulation and enter reality. If you wish to do so, proceed through this door. {\bf You MUST interact with the sign on the table before you take any action in this room}.}
  \s\MYloc	{-015}
  \s\MYtext	{\#9999}
  }
...
\NEW{Sign}{\sPossessABody}{
  ...
  \s\MYloc	{-015}
  \s\MYtext	{Since you are normally just a mind in a simulation, you must posess a body in order to exist in the real world. Below are a set of three robot bodies you may posess. If you choose to do so, pick up one of the index cards labeled ``Robot'' and carry it with you at all times while you are in reality.
  
  Unless you know otherwise, you may not possess an alien body.} %% We will tape 3 notecards to the door below this sign
  }

\NEW{Sign}{\sAlienBodies}{
  \s\MYname	{A Pair of alien bodies}
  \s\MYloc	{-015}
  \s\MYtext	{There are the bodies of two strange beings seated cross legged on the floor, with their eyes closed as if asleep. You have never seen anything like these before.
...
\NEW{Sign}{\sPileOfJunk}{
  ...
  \s\MYitems {\iWidget{}\multi{4}{\iwire{}}\iBible{}}
  }
...
For every 30 seconds spent in this room, lower your Ω by 1.}
  \s\MYitems {}
  }
 %% THIS IS A GLITCH ITEM and it needs a star sticker
