...
\NEW{Item}{\iGun}{
 ...
 With this gun, you receive +2 offensive CR, and may attack from up to 3 ZoC away. Your attack cannot be assisted, though defense against it can be. This gun has 4 bullets. Keep track of how many times the gun has been shot and write the remaining bullets on this item card.}
}
