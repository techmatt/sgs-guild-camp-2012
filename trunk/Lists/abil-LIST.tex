...
\NEW{Abil}{\aDetectSavedState}{
  ...
  \s\MYtext	{You can use your Gieger Counter to detect if someone has been around radiation for the last few hours.  If someone doesn't have a $\beta$ score, they are clean.  If they have a $\beta$ score of 1, they have been close to the radioactive item for some time.  If they have a $\beta$ score of 2, they have been in close, likely continuous, contact with a radioactive item.}
