...
\NEW{Abil}{\aDetectSavedState}{
  ...
  \s\MYtext {If you are in the 1 ZOC and line-of sight of an adult, you may use this ability on them. You may ask them for your teddy bear back. You may only use this once on each adult.}
  \s\MYeffect	{Give me the teddy bear.}
}

  \NEW{Abil}{\aDonate}{
  \s\MYname	{Solicit Donation}
  \s\MYtext {If you talk with someone for 5 minutes straight about Virtuism, you can force someone to give you an item of their choice as a 'donation' to the church of Virtuism.}
  \s\MYeffect	{Give me an item of your choice.}
}
...
\NEW{Abil}{\aPossessAlienBody}{
  ...
  \s\MYtext {You have the ability to possess an alien body if you leave the simulation and return to your body. You do not have the ability to possess a robot body.}
