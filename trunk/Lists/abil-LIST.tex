...
\NEW{Abil}{\aBulky}{
  ...
  \s\MYtext {Since you are incoporeal, no one can pick up your body and move it anyplace. Show this ability to anyone attempting to do so.}
  \s\MYeffect {Your hands pass right through my body and you fail to pick it up.}
}

\NEW{Abil}{\aIncoporeal}{
  \s\MYname	{I am Incoporeal}
  \s\MYtext {Since you are incoporeal, attacks pass right through you. You take no damage and feel no effect. NOTE: you cannot attack anyone either.}
  \s\MYeffect {Your attack passes right through my body with no apparent effect.}
}
