...
\NEW{PC}{\cActive}{
  ...
  \s\MYblues	{}
  \s\MYgreens	{\gVirus{}}
  \s\MYabils	{\aMentalDegradation{}\aCollectBlood{}}
  \s\MYitems	{}
  \s\MYomega	{12} % Corruption
\s\MYmems {\mVirus{}\mDead{}\mBrainDamageEnvelope{}}
 }
...
\NEW{PC}{\cGroomB}{
   ...
   \s\MYfile	{GroomB.tex}
   \s\MYsex      {\male}
   \s\MYnumber	{429} %can they have exactly the same badge #?  Yes -Ghost
