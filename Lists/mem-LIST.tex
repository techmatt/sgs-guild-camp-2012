...
\NEW{MemCover}{\mGroomA}{
  \s\MYname	{Mirror}
  \s\MYmems	{\mGroomAPageOne{}\mGroomAPageTwo{}\mGroomAPageThree{}\mGroomAPageFour{}\mGroomAPageFive{}\mGroomAPageSix{}\mGroomAPageSeven{}}
}
...
\NEW{MemPage}{\mGroomAPageTwo}{
  ...
  \s\MYtext	{That is impossible. This man is claiming to be you. He's trying to steal your identity! You think you've heard about that sort of thing on the news. You must prove that you are yourself. 
  Find your military ID because it has your fingerprints on it . \(item \# 192\)
  A childhood photo of you. There is no way the imposter could recognize it. \(item \# 156\)
  Your cellphone. You haven't seen it all day. Maybe you misplaced it at the rehersal dinner last night. \(item \# 185\)
  A tin soldier. This was a family heirloom, but you haven't seen it in years -- not since \cScientist{} left you. \(item \# 185\)
  }
  }
}
}
...
\NEW{MemPage}{\mGroomAPageThree}{
  \s\MYname	{You hear 439's guess as to your bank account number.}
  \s\MYtext	{What... that's.... impossible. Absolutely impossible. There can't possibly be two of you \ldots can there? It's time for desperate measures. Ask your fiancee, \cBride{} which of you is the real \cGroomA{} Turn to page Six if she says you are real. Turn to page Seven if she says you are not.}
}
...
\NEW{MemCover}{\mGroomB}{
  \s\MYname	{Me}
  \s\MYmems	{\mGroomBPageOne{}\mGroomBPageTwo{}\mGroomBPageThree{}\mGroomBPageFour{}\mGroomBPageFive{}\mGroomBPageSix{}\mGroomBPageSeven{}}
...
\NEW{MemPage}{\mGroomBPageOne}{
  ...
  \s\MYname	{438 tells you his name}
  \s\MYtext	{That is impossible. This man is claiming to be you. He's trying to steal your identity! You think you've heard about that sort of thing on the news. You must prove that you are yourself. Find your military dogtags. The dogtags have your fingerprints on them. Compare them with him. That will prove it.}
  }
  
  \NEW{MemPage}{\mGroomBPageThree}{
  \s\MYname	{You compare fingerprints with 438}
  \s\MYtext	{DAMN. Your fingerprints are the same! He must be wearing fakes. This man is a professional. Likely a government spy from a regime you've sold weapons to. But he claims to be you. You must prove your identity before you can uncover his true nature. Find a personal, childhood photograph of yours, and confront 438 with it. There's no way he'd be able to recognize it.}
  }

  \NEW{MemPage}{\mGroomBPageFour}{
  \s\MYname	{You confront 438 about the photograph.}
  \s\MYtext	{He must have interrogated your family members, to know this. You'll need to make sure they're all right, and notify the police, as soon as this resolves. But there's one thing he'll never know. Your bank account number. It's encrypted and you've never told it to a soul. Make him tell it to you.}
  }
  
    \NEW{MemPage}{\mGroomBPageFive}{
  \s\MYname	{You hear 438's guess as to your bank account number.}
  \s\MYtext	{What... that's.... impossible. Absolutely impossible. There can't possibly be two of you \ldots can there? It's time for desperate measures. Ask your fiancee, \cBride{} which of you is the real \cGroomA{} Turn to page Six if she says you are real. Turn to page Seven if she says you are not.}
  }


   \NEW{MemPage}{\mGroomBPageSix}{
   % Note: MYname can't contain \cBride{} because LaTeX is annoying
  \s\MYname	{Your fiancee tells you that you are real.}
  \s\MYtext	{Yes! You are the real you! Now, go deal with the imposter.}
  }
  
   \NEW{MemPage}{\mGroomBPageSeven}{
  % Note: MYname can't contain cBride{} because LaTeX is annoying   
  \s\MYname	{Your fiancee tells you that 348 is real.}
  \s\MYtext	{What... how could she? How \emph{could} she!?
