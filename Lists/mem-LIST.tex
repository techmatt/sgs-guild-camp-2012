...
\NEW{MemEnvelope}{\mBrainDamageEnvelope}{
  \s\MYname	{M Packet}
  \s\MYtext	{You have a splitting headache, likely coming from your body back on the human ship. Read and use the ability enclosed in this packet. Also open up to page one of the enclosed notebook.}
  }
