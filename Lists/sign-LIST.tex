...
\NEW{Sign}{\sBarCounter}{
  ...
  T}
  \s\MYitems {\multi{10}{\iWine{}}\multi{10}{\iVial{}}} 
  }
...
\NEW{Sign}{\sPileOfWood}{
  ...
  A}
  \s\MYitems {\multi{3}{\iTwoByFour{}}\multi{3}{\iRope{}}}
  }
...
If you have a net-like device and make a CR 2 attack, you can catch the fish. Open the packet below.}
  \s\MYitems {\iFish{} }
  }
%% THIS IS A GLITCH ITEM and it needs a star sticker
...
\NEW{Sign}{\sFlowers}{
  ...
  \s\MYloc	{Main Hallway}
  \s\MYtext	{What a lovely flower arrangement! These would look quite nice at the wedding.
...
\NEW{Sign}{\sGiftShopStuffies}{
  ...
  \s\MYitems {}%%A GM will put the item into the envelope when the utopia state appears in game
  }
