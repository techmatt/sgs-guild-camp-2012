...
\NEW{Sign}{\sActiveRoom}{
  \s\MYname	{A Hotel Room}
  \s\MYloc	{- 004}
  \s\MYtext	{The name plaque says {\bf \cActive{\MYname{}}}.  If you have the room key with item {\bf \# 106}, you may enter the room.}
  \s\MYitems {\iBible{}}
  }
...
\NEW{Sign}{\sBarCounter}{
  ...
  The items here are essencially infinate. If the envelop is empty, tell a GM.
}
...
But on closer inspection, this aquarium lacks glass. It is simply a cube of water, held in the shape of a cube by god-knows-what, with some very confused fishes swimming around haphazardly inside.
