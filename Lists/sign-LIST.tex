...
\NEW{Sign}{\sPastorRoom}{
  \s\MYname	{\cPastor{\MYname{}}'s Hotel Room}
  \s\MYloc	{- 004}
...
\NEW{Sign}{\sHighSecurityDoorLocked}{
  ...
  \s\MYloc	{Near -013}
  \s\MYtext	{This steel door looks important. It has a keyhole instead of a card reader. If you have item {\bf \# 125} you may open the door. Replace this sign with the one under it. You may then take any item from this room that you wish to take.}
