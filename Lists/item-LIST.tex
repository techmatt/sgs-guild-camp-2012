...
\NEW{ItemFold}{\iTV}{
  \s\MYname	{A television set.}
  \s\MYnumber {0146}
  \bulky{2}
  \s\MYtext	{An old-fashioned television. It can be broken apart with an attack, at which point you may open the envelope below.}
   \s\MYcontents{Cross out the 'Television' card and make a "Solenoid" item card of 1 hand bulky.}
...
%% Reality
\NEW{Item}{\iCable}{
  \s\MYname	{A metal cable}
  \s\MYnumber {0149}
  \bulky{1}
  \s\MYtext	{This is a strong cable and could restrain even a robot.}
  }
...
%%  {\iClothes}
  ...
  \s\MYnumber	{0111}
  \s\MYtext	{A bizarre-looking probelike device.}
  } %% One in Construction site, one in Spa, one in Gift Shop, and one in Rival's hotel room.
