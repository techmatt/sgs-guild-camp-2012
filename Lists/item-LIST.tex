...
\NEW{Item}{\iLapelPin}{
  ...
  \s\MYnumber	{0163}
  \s\MYtext	{A small lapel pin. It should be given to the groom by the father of the bride. If he is unavailable, the Pastor will bestow the lapel pin. The groom must posess the lapel pin for the wedding to proceed.}
}
