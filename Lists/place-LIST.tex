...
\NEW{Place}{\pRoomfour}{
  \s\MYname	{Room -004}
  \s\MYsigns	{\sHotelRooms{}\sBrideRoom{}\sGroomRoom{}\sScientistRoom{}\sRivalRoom{}\sPastorRoom{}\sActiveRoom{}}
  }
...
\NEW{Place}{\pGM}{
  ...
  \s\MYitems  {\iCompleteHeadMountedDisplay{}\iCompleteMentalAmplifier{}\iBunnyRabbit{}}
  }